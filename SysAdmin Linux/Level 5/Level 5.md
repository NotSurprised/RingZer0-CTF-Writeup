# Level 5
![](https://i.imgur.com/umVq5U2.png)
```shell
ssh morpheus@challenges.ringzer0team.com -p 10089
VNZDDLq2x9qXCzVdABbR1HOtz
ssh -i ssh oracle@challenges.ringzer0team.com -p 10149
```
...
Here's something we want:

```shell
alias reveal="openssl enc -aes-256-cbc -a -d -in encflag.txt.enc -k 'lp6PWgOwDctq5Yx7ntTmBpOISc'"
```

We can easily type command `reveal` to get the flag.
