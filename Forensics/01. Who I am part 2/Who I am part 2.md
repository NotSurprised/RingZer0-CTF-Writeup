...
To validate someone, public key, footprint or signature will be useful.

Seems PGP can fit exactly what we're looking for.

Just simply search googel with : `PGP` & Owner of Ringzer0 website `MrUn1k0d3r`, to find there's any page hold this message in public.

![](https://i.imgur.com/5FVDQhs.png)
